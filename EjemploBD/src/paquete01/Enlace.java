...
public class Enlace {
    ...
    public void insertarCiudad(Ciudad ciudad) {
        ...
        try {
            ...
            // "Ciudad" Es el nombre de la tabla que esta creada en la base de 
            // datos.
    ...
    public ArrayList<Ciudad> obtenerDataCiudad() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                // Utiliza getString porque el valor de nombre en la base de
                // datos es de tipo String, de la misma forma se usa getInt
                // porque el valor de poblacion en la base de datos es int
